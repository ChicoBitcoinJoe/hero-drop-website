...
export default function Dao({ Links }) {
  return <>    
    ...
    <Typography component={Grid} container variant="h4" sx={{ pt: 8 }}>
      The Hero Drop Community DAO
    </Typography>
    <Grid item xs={12} sx={{ pt: 2, pr: { xs: 0, md: 4 } }}>
      <Typography variant="body1">
        The Community DAO holds blockchain assets such as cryptocurrencies and NFTs. Funds sent to the DAO are used to pay for permanent positions as well as anything else the DAO votes on. Shares are used for voting whereas Loot has the same value as a Share but has no voting power. Initially, each Share and Loot can be purchased for 1 Dai each, and should you not wish to participate in the DAO anymore you can reclaim your portion of the treasury.
      </Typography>
    ...
    <Grid container sx={{ ml: { xs: 1, sm: 4 } }}>
      <ol>
        ...
        <li>
          <Typography alignItems="center" item variant="body1" sx={{ ml: 2, mt: 2 }}>
            Enter 1 dai per voting share you desire for “Tribute Offered”
          </Typography>
        </li>
        <li>
          <Typography alignItems="center" item variant="body1" sx={{ ml: 2, mt: 2 }}>
